...
alias launch_rtabmap='roslaunch rtabmap_ros rtabmap.launch \
   ...
   queue_size:=30'
alias launch_realsense='roslaunch realsense2_camera rs_d400_and_t265.launch'
